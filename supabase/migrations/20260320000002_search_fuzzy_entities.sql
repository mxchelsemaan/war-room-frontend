-- Add fuzzy matching on named_entities via pg_trgm similarity().
-- Handles alternate spellings: khamenai → khamenei, natanyahu → netanyahu, etc.
-- Uses existing trigram index: idx_named_entities_normalized_trgm.
